        ...
        <Tabs value="name1" class="tabs">
            <TabPane label="待分配" name="name1">
                <div class="top">
                    ...
                    <div style="margin-left: 40px;">待分配提纲 <span style="color: #4098ff">{{total}}</span></div>
                </div>
            ...
            <TabPane label="审核中" name="name2">
                ...
                <tables :tabel-height="tableHeight" :column="columns2" :table-data="list2"/>
                <page-list :current="current" :total="total" :page-size="pageSize" @page-list="pageList"/>
            </TabPane>
            <TabPane label="已审核" name="name3">
                ...
                <tables :tabel-height="tableHeight" :column="columns3" :table-data="list3"/>
                <page-list :current="current" :total="total" :page-size="pageSize" @page-list="pageList"/>
            </TabPane>
        </Tabs>
    </div>
        ...
        methods: {
            ...
            getListAwait() {
                ...
                let d = {
                    ...
                    organization_id: this.$config.getRoleId(),
                    state: 3
                }
