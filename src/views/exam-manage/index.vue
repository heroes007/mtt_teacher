    ...
    export default {
        ...
        data (){
            return{
                ...
                select2: [{title: '全部状态', id: 'all'},{title: '考试中', id: 1}, {title: '已结束', id: -1}, {title: '未开始', id: 0}],
                room_state: ''
            }
        },
        methods: {
            ...
            deletes(row,rowIndex){
                this.$config.deleteModal(() => {
                    this.$config.fnPost('exam/removeExam', {id: row.id}, () => { this.getList() })
                })
            },
            inputChange(val){
                this.keyword = val;
            ...
            getList(){
                ...
                postData('exam/getRoomList', d).then((res) => {
